...
if(strpos($message, "/schk ") === 0 || strpos($message, "!schk ") === 0){   
    ...
    if($antispam != False){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
        'text'=>"[<u>SPAM ELEME GOT</u>] biraz gözlə <b>$antispam</b>s.",
        'parse_mode'=>'html',
        ...
        if(preg_match_all("/(\d{16})[\/\s:|]*?(\d\d)[\/\s|]*?(\d{2,4})[\/\s|-]*?(\d{3})/", $lista, $matches)) {
            ...
            if(!preg_match_all("/sk_(test|live)_[A-Za-z0-9]+/", $sec, $matches)) {
                bot('editMessageText',[
                    ...
                    'text'=>"<b>İstifadə üçün sk daxil et /apikey sk_live</b>",
                    'parse_mode'=>'html',
...
<b>Bot By: <a href='t.me/BossNetworkk'>Boss Networkk</a></b>",
                    'parse_mode'=>'html',
                    'disable_web_page_preview'=>'true'
